...
function getUserModules(payload) {
  return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_1___default()(new Request(prefixHostAddress('/v1/modules/getUserModules')), {
    method: 'post',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
...
//# sourceMappingURL=_app.js.964bb109e59346c79336.hot-update.js.map