...
function getUserModules(payload) {
  return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_1___default()(prefixHostAddress("/v1/modules/getUserModules/?".concat(qs.stringify)), {
    method: 'get',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
...
//# sourceMappingURL=_app.js.26e98520d585e7f615c3.hot-update.js.map