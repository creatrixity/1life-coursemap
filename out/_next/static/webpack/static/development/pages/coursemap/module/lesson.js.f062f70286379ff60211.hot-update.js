      ...
      var content = htmr__WEBPACK_IMPORTED_MODULE_2___default()(lessonContent, {
        transform: {
          ...
          ratingfeedback: function ratingfeedback(props) {
            var displayThresholdType = props.displayThresholdType,
                displayThreshold = props.displayThreshold;

            if (displayThresholdType === 'range') {
              var _props$displayThresho = props.displayThreshold.split(','),
                  _props$displayThresho2 = _slicedToArray(_props$displayThresho, 2),
                  rangeStart = _props$displayThresho2[0],
                  rangeEnd = _props$displayThresho2[1];

              if (60 >= rangeStart && 60 <= rangeEnd) {
                return props.children;
              }
            }

            if (60 >= displayThreshold) {
              return props.children;
            }
...
//# sourceMappingURL=lesson.js.f062f70286379ff60211.hot-update.js.map