  ...
  _createClass(LessonPage, [{
    ...
    value: function handleSaveJournalInput(_ref2, callback) {
      ...
      this.props.createJournalFeedback({
        ...
        // 	return feedbackData[key].type === 'rating'
        // })
        var feedbackData = _this3.props.app.courseMapModulesFeedback[_this3.currentCourse.id][_this3.currentCourseModule.id][_this3.lessonId];
        console.log(feedbackData); // const ratingCumulative = feedbackDataKeys.reduce((previousValue:any, currentValue:any, currentIndex:any) => {
        // 	return parseInt(previousValue) + parseInt(feedbackData[feedbackDataKeys[currentIndex]].answer);
        // }, 0)
        // this.setState({
        // 	ratingCumulative
...
//# sourceMappingURL=lesson.js.a7ff31e48021c4bce190.hot-update.js.map