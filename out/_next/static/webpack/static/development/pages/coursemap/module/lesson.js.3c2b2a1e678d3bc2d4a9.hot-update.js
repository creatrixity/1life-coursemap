  ...
  _createClass(LessonPage, [{
    ...
    value: function refreshFeedback(_ref) {
      ...
      this.props.getJournalFeedback({
        ...
        var feedbackData = feedback[courseId][moduleId.id][lessonId];
    ...
    value: function handleSaveJournalInput(_ref3, callback) {
      ...
      this.props.createJournalFeedback({
        ...
        var coursemapModulesFeedback = _this4.props.app.coursemapModulesFeedback;
      });
    }
  }, {
    key: "render",
...
//# sourceMappingURL=lesson.js.3c2b2a1e678d3bc2d4a9.hot-update.js.map