  ...
  _createClass(LessonPage, [{
    ...
    value: function handleSaveJournalInput(_ref2, callback) {
      ...
      this.props.createJournalFeedback({
        ...
        // 	return feedbackData[key].type === 'rating'
        // })
        // let feedbackData = this.props.app.courseMapModulesFeedback[this.currentCourse.id][this.currentCourseModule.id][this.lessonId]
        console.log(data); // const ratingCumulative = feedbackDataKeys.reduce((previousValue:any, currentValue:any, currentIndex:any) => {
        // 	return parseInt(previousValue) + parseInt(feedbackData[feedbackDataKeys[currentIndex]].answer);
        // }, 0)
        // this.setState({
        // 	ratingCumulative
...
//# sourceMappingURL=lesson.js.4aff74300e192ac2ddb0.hot-update.js.map