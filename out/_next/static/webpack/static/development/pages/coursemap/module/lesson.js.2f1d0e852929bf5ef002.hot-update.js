  ...
  _createClass(LessonPage, [{
    ...
    value: function handleSaveJournalInput(_ref2, callback) {
      ...
      this.props.createJournalFeedback({
        ...
        // const { app: { courseMapModulesFeedback } } = this.props
        console.log(_this3.props.app); // const ratingCumulative = feedbackDataKeys.reduce((previousValue:any, currentValue:any, currentIndex:any) => {
        // 	return parseInt(previousValue) + parseInt(feedbackData[feedbackDataKeys[currentIndex]].answer);
        // }, 0)
        // this.setState({
        // 	ratingCumulative
...
//# sourceMappingURL=lesson.js.2f1d0e852929bf5ef002.hot-update.js.map