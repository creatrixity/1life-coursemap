  ...
  _createClass(LessonPage, [{
    ...
    value: function handleSaveJournalInput(_ref2, callback) {
      ...
      this.props.createJournalFeedback({
        ...
        var currentData = coursemapModulesFeedback[_this3.currentCourse.id][_this3.currentCourseModule.id][_this3.lessonId];
        var a = Object.keys(currentData).filter(function (key) {
          return currentData[key].id === data.id;
        })[0];

        var feedbackData = _objectSpread({}, currentData, _defineProperty({}, a, data));
...
//# sourceMappingURL=lesson.js.174ceb4e75bf7d806a21.hot-update.js.map