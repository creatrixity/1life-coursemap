...
function (_React$Component) {
  ...
  function JournalInput(props) {
    ...
    _this.handleJournalRatingChange = _this.handleJournalRatingChange.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this._makeRequest = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["debounce"])(_this._makeRequest, 5000);
    return _this;
  }
  ...
  _createClass(JournalInput, [{
    ...
    value: function componentDidMount() {
      ...
      var val = value === '' && type === 'rating' ? '0' : value;
      this.setState({
        value: val
      });
    }
    ...
    key: "renderRating",
    value: function renderRating(label, value) {
      return react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", {
        ...
        fullSymbol: react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_Icons__WEBPACK_IMPORTED_MODULE_3__["StarIcon"], {
          fill: "yellow"
        }),
    ...
    key: "handleJournalRatingChange",
    value: function handleJournalRatingChange(rate) {
      var value = "".concat(rate);
      this.setState({
        value: value
      });
...
//# sourceMappingURL=lesson.js.8afff6fb30ee6d3c694c.hot-update.js.map