  ...
  _createClass(LessonPage, [{
    ...
    value: function handleSaveJournalInput(_ref2, callback) {
      ...
      this.props.createJournalFeedback({
        ...
        console.log(courseMapModulesFeedback); // const ratingCumulative = feedbackDataKeys.reduce((previousValue:any, currentValue:any, currentIndex:any) => {
        // 	return parseInt(previousValue) + parseInt(feedbackData[feedbackDataKeys[currentIndex]].answer);
        // }, 0)
        // this.setState({
        // 	ratingCumulative
...
//# sourceMappingURL=lesson.js.03b171dc97701a901ded.hot-update.js.map