  ...
  _createClass(LessonPage, [{
    ...
    value: function handleSaveJournalInput(_ref2, callback) {
      ...
      this.props.createJournalFeedback({
        ...
        console.log(_this3.props.app.courseMapModulesFeedback[_this3.currentCourse.id][_this3.currentCourseModule.id]); // const ratingCumulative = feedbackDataKeys.reduce((previousValue:any, currentValue:any, currentIndex:any) => {
        // 	return parseInt(previousValue) + parseInt(feedbackData[feedbackDataKeys[currentIndex]].answer);
        // }, 0)
        // this.setState({
        // 	ratingCumulative
...
//# sourceMappingURL=lesson.js.c6db774dcb6839e5c8e6.hot-update.js.map