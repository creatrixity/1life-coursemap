  ...
  _createClass(LessonPage, [{
    ...
    value: function componentDidMount() {
      ...
      this.props.getJournalFeedback({
        ...
        feedbackDataKeys.reduce(function (previousValue, currentValue, currentIndex) {
          console.log(feedbackData[feedbackDataKeys[currentIndex]]);
          return previousValue + parseInt(feedbackData[feedbackDataKeys[currentIndex]]);
        }, 0);
      });
    }
  }, {
      ...
      var content = htmr__WEBPACK_IMPORTED_MODULE_2___default()(lessonContent, {
        transform: {
          ...
          ratingfeedback: function ratingfeedback(props) {
            ...
            var _this3$state$ratingCu = _this3.state.ratingCumulative,
                ratingCumulative = _this3$state$ratingCu === void 0 ? 0 : _this3$state$ratingCu;
            ...
            if (ratingCumulative >= parseInt(rangeStart) && ratingCumulative <= parseInt(rangeEnd)) {
...
//# sourceMappingURL=lesson.js.10ac37b649b63aeb7a73.hot-update.js.map