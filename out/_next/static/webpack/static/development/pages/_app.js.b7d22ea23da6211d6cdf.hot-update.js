...
function updateUserLesson(payload) {
  ...
  return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_1___default()(prefixHostAddress("/v1/modules/updateUserLesson?".concat(JSON.stringify(payload))), {
    method: 'GET',
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json',
...
//# sourceMappingURL=_app.js.b7d22ea23da6211d6cdf.hot-update.js.map