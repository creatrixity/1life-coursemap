...
function (_React$Component) {
  ...
  _createClass(LessonPage, [{
    ...
    value: function renderUpcomingLinks() {
      var moduleLessons = this.props.getCourseModuleLessons(this.moduleId);
    ...
    value: function componentDidMount() {
      ...
      var _ref4 = router.query,
          course = _ref4.course,
          lesson = _ref4.lesson,
          module = _ref4.module; // const { coursemapModules, coursemapModulesContent } = app;

      var courseId = Object(_src_Helpers__WEBPACK_IMPORTED_MODULE_14__["extractIdFromSlug"])(course);
      var moduleId = Object(_src_Helpers__WEBPACK_IMPORTED_MODULE_14__["extractIdFromSlug"])(module);
      var lessonId = Object(_src_Helpers__WEBPACK_IMPORTED_MODULE_14__["extractIdFromSlug"])(lesson);
...
//# sourceMappingURL=lesson.js.7f14a3ace4aef26d32ef.hot-update.js.map